...
def main() -> None:
    ...
    ap.add_argument(
        ...
        metavar="TASK",
        help=(
            "Ordered list of capability tasks. "
            "Default: gsm8k sst2 mbpp xsum sciq multiwoz (6-task chain). "
            "3-task chain: --task-order gsm8k sst2 mbpp"
        ),
    )
    ...
    ap.add_argument(
        ...
        type=str,
        default=None,
        help="If set, write per-stage eval results to this JSON file (for multi-seed aggregation).",
    )
    args = ap.parse_args()
    ...
    if args.results_json:
        ...
        print(f"[sequential] results written to {args.results_json}")
